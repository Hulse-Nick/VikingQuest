...
public class Map implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 37 * hash + (int) (Double.doubleToLongBits(this.xCount) ^ (Double.doubleToLongBits(this.xCount) >>> 32));
        hash = 37 * hash + (int) (Double.doubleToLongBits(this.yCount) ^ (Double.doubleToLongBits(this.yCount) >>> 32));
        return hash;
    }
